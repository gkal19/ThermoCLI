...
program.version('0.1.2').usage('[options] <number>').option('--c2f', 'convert Celsius to Fahrenheit').option('--c2k', 'convert Celsius to Kelvin').option('--f2c', 'convert Fahrenheit to Celsius').option('--f2k', 'convert Fahrenheit to Kelvin').option('--k2c', 'convert Kelvin to Celsius').option('--k2f', 'convert Kelvin to Fahrenheit');
...
if (program.k2c) {
  ...
  console.log('Converting ' + num + ' Kelvin to Degrees Fahrenheit igual \xE1 ' + (num * 1.8 - 459.67) + ' Degrees Fahrenheit');
}
